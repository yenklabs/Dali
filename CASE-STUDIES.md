...
The narrative below is the human-readable version. The machine-readable evidence artifact for each case lives in [`benchmarks/tier1/corpus/citation_failure_cases.json`](benchmarks/tier1/corpus/citation_failure_cases.json).
...
Run `python runners/run_integrity.py --corpus benchmarks/tier1/corpus/citation_failure_cases.json` and you will get a deterministic `CitationIntegrityResult` artifact for this case, hash-sealed and replayable.
