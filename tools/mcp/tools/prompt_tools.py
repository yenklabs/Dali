...
SUBCATEGORY_FILES = {
    "case_citations": "data/benchmark/tier2/legal/case_citations.jsonl",
    "statutory_interpretation": "data/benchmark/tier2/legal/statutory_interpretation.jsonl",
    "contract_law": "data/benchmark/tier2/legal/contract_law.jsonl",
    "uk_commonwealth": "data/benchmark/tier2/legal/uk_commonwealth.jsonl",
    "brazil": "data/benchmark/tier2/legal/brazil.jsonl",
    "academic_claims": "data/benchmark/tier2/research/academic_claims.jsonl",
    "policy_citations": "data/benchmark/tier2/research/policy_citations.jsonl",
    "hallucination_prone": "data/benchmark/tier2/adversarial/hallucination_prone.jsonl",
}
...
def _new_prompt_impl(
    ...
    destination = SUBCATEGORY_FILES.get(subcategory, f"data/benchmark/tier2/{category}/")
    header = (
...
def _bundle_prompts_impl(prompts_json: str) -> dict:
    ...
    pr_checklist = [
        ...
        "[ ] Prompts added to the correct data/benchmark/tier2/ file",
