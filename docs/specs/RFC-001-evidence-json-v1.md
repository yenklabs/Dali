...
```json
{
  "$schema": "https://raw.githubusercontent.com/yenk/Dali/main/dali/schemas/evidence-bundle.schema.json",
...
The reference evaluator in `dali/runners/run_integrity.py` emits per-citation
`CitationIntegrityResult` records (see [dali/schemas/integrity-result.schema.json](../../dali/schemas/integrity-result.schema.json)).
...
roadmap item in [docs/roadmap.md](../roadmap.md). Until then, conformant
producers should construct the bundle envelope from the documented schema
in §3.1.

Machine-readable schemas:
- [`dali/schemas/evidence-bundle.schema.json`](../../dali/schemas/evidence-bundle.schema.json): bundle envelope
- [`dali/schemas/integrity-result.schema.json`](../../dali/schemas/integrity-result.schema.json): per-citation record
