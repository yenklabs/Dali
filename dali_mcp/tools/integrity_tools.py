...
Same code path as ``runners/run_integrity.py``; the cryptographic lineage
...
from corpus.loader import _case_from_raw
from corpus.policy import POLICY_VERSION
from corpus.schema import CitationIntegrityResult
from runners.run_integrity import evaluate_local
...
def _verify_replay_impl(record_json: str) -> dict:
    ...
    The MCP equivalent of ``runners/run_integrity.py --verify-replay``.
