...
Usage in CLI:
    ...
    python -m dali.runners.run_synthetic --models openai_fast

    # Raw model ID still works
    python -m dali.runners.run_synthetic --models gpt-4o-mini-2024-07-18

Alias resolution:
    openai_fast  →  gpt-4o-mini-2024-07-18  (pinned, recommended for public benchmarks)

Public benchmark policy:
    Use pinned=True aliases for any run committed to data/results/.
...
def resolve_model(alias_or_id: str) -> dict[str, Any]:
    ...
    from dali.runners.models import MODELS
    ...
    raise ValueError(
        ...
        f"Use 'python -m dali.runners.run_synthetic --list-models' to see all options."
    )
