...
> in [`dali/corpus/taxonomy.py`](../corpus/taxonomy.py) (normative Python enum) and
> documented in the [METHODOLOGY.md Failure class taxonomy](../../docs/METHODOLOGY.md#failure-class-taxonomy)
